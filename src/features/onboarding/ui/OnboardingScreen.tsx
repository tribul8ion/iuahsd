  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col" style={{ padding: "60px 24px 32px 24px" }}>
        ...
        >
          <KeyRound size={32} color="#2C3400" strokeWidth={2} />
        </div>
        ...
        <div className="flex flex-col" style={{ gap: 12, flexShrink: 0 }}>
          ...
          >
            <input
              ...
              style={{ marginTop: 3, accentColor: "#F9FFD0", width: 16, height: 16 }}
            />
            <span className="text-[13px]" style={{ color: "var(--color-text-secondary)", lineHeight: 1.45 }}>
              {t("onboarding.ack")}
            </span>
          </label>
